...
public class StupetitionExceptionHandler {

    @ResponseStatus(value = HttpStatus.CONFLICT)
    @ExceptionHandler(StupetitionException.class)
    public ErrorResponse handleStupetitionException(StupetitionException e, HttpServletRequest request) {
